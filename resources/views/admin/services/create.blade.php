...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Créer un nouveau service</h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('responsable_nom') is-invalid @enderror"
                            id="responsable_nom" name="responsable_nom" value="{{ old('responsable_nom') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('responsable_email') is-invalid @enderror"
                            id="responsable_email" name="responsable_email" value="{{ old('responsable_email') }}">
